...
@descargarDynamo_bp.route('/procesar_Dynamo', methods=['POST'])
def procesar_Dynamo():
    ...
    try:
        ...
        output_path = 'static/archivoDynamo.xlsx'
...
@descargarDynamo_bp.route('/descargar_Dynamo')
def descargar_Dynamo():
