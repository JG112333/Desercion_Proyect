...
def procesar_csv():
    ...
    try:
        ...
        try:
            ...
            # # Convertir la columna a tipo cadena antes de realizar el mapeo
            # df['Estado civil'] = df['Estado civil'].astype(str)
            # df['Modo de admision'] = df['Modo de admision'].astype(str)
            # df['Asistencia diurna o nocturna'] = df['Asistencia diurna o nocturna'].astype(str)
            # df['Cualificacion previa'] = df['Cualificacion previa'].astype(str)
            # df['Ocupacion de la madre'] = df['Ocupacion de la madre'].astype(str)
            # df['Ocupacion del padre'] = df['Ocupacion del padre'].astype(str)
            # df['Desplazado'] = df['Desplazado'].astype(str)
            # df['Deudor'] = df['Deudor'].astype(str)
            # df['Cuotas de matricula al dia'] = df['Cuotas de matricula al dia'].astype(str)
            # df['Genero'] = df['Genero'].astype(str)
            # df['Becado'] = df['Becado'].astype(str)
