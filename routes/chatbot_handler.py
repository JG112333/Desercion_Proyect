...
client = OpenAI(api_key="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", base_url="https://openrouter.ai/api/v1")
...
def chatbot():
    if request.method == 'POST':
        ...
        predefined_responses = {
            ...
            "¿Cómo funciona el modelo de Machine Learning?": (
        ...
        if not skip_restriction:
            ...
            bot_message = chatbot.choices[0].message.content
